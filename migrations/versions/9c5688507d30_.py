...
Revision ID: 9c5688507d30
Revises: 
Create Date: 2025-01-08 15:56:29.456414
...
def upgrade():
    ...
    if environment == "production":
        ...
        op.execute(f"ALTER TABLE mtm_parents SET SCHEMA {SCHEMA};")
        op.execute(f"ALTER TABLE parent_a SET SCHEMA {SCHEMA};")
        op.execute(f"ALTER TABLE parent_b SET SCHEMA {SCHEMA};")
        op.execute(f"ALTER TABLE users SET SCHEMA {SCHEMA};")
        op.execute(f"ALTER TABLE child_a SET SCHEMA {SCHEMA};")
        op.execute(f"ALTER TABLE child_b SET SCHEMA {SCHEMA};")
        op.execute(f"ALTER TABLE mtm_parent_children SET SCHEMA {SCHEMA};")
